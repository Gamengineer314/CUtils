...
// Throw an error and a given message if func is not 0. errno is used for the error code.
...
// Throw an error and a given message if func is not 0. func is used for the error code.
...
// Throw an error and a given message if func is 0. errno is used for the error code.
...
#define THROW_P(func, err) func; if (err) _throw(err)
// Execute func and throw an error and a given message if err is not 0. err is used for the error code.
#define THROW_P_MSG(func, err, msg, ...) func; if (err) _throw_msg(err, msg, ##__VA_ARGS__)

// Throw an error if func is not 0. func is used for the error code but is not converted to a string.
#define THROW_RC(func) errno = func; if (errno) _throw_c(errno);
// Throw an error and a given message if func is not 0. func is used for the error code but is not converted to a string.
#define THROW_RC_MSG(func, msg, ...) errno = func; if (errno) _throw_c_msg(errno, msg, ##__VA_ARGS__);
...
// Execute func and throw an error and a given message if err is not 0. err is used for the error code but is not converted to a string.
